...
5. find character width calculation and character position offset problem in 8bpp mode.Fixed it but no time to check 1bpp mode.Split 2 codes temporarily
